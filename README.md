...
<!--lint enable double-link-->
- [django-classy-settings](https://django-classy-settings.readthedocs.io/en/latest/) - Class based settings to keep your environments in order, with easy access to typed environment variables.

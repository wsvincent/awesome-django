...
- [pytest-mrt](https://github.com/croc100/pytest-mrt) - Verify Django migrations are safely reversible via static analysis (44 patterns, no DB needed) and dynamic up/down/up cycle testing against a real database.

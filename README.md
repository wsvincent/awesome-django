...
- [sneat-bootstrap-django-admin](https://themeselection.com/item/sneat-bootstrap-django-admin-template/) - A developer-friendly Django admin template for powerful web apps
